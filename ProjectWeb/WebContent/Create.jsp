...
<a href="consultation">    
  	...
  	<div class="tab-pane fade show active" id="client">
   			<form action="creation" method="post">
                ...
                <div class="form-group">
                    <button class="btn btn-info btn-lg btn-block">Créer ce client</button>
                </div>
            </form>
  	</div>
    ...
    <form action="creation" method="post">
                ...
                <div class="form-group mb-3">
                    <input class="form-control form-control-lg" placeholder="Le mot de passe de cet employé" type="password" name="epass" required>
                </div>
                <div class="form-group mb-3">
                    <input class="form-control form-control-lg" placeholder="Le solde de cet employé" type="number" name="esolde" required>
                </div>
                <div class="form-group">
                    <button class="btn btn-info btn-lg btn-block">Créer cet employé</button>
                </div>
            </form>
  	</div>
    ...
    <form action="creation" method="post">
                ...
                <div class="form-group">
                    <button class="btn btn-info btn-block">Créer ce groupe</button>
                </div>
    </form>
    </div>
    ...
    <form action="creation" method="post">
                ...
                <div class="form-group">
     			...
     			<div class="form-group mb-3">
      				<label for="exampleSelect1" class="form-label mt-4">Choisissez l'employé</label>
                ...
                <div class="form-group mb-3" id="td" >
                    <input class="form-control form-control-lg" placeholder="Le Découvert" type="number" name="cdec">
                </div>
                ...
                <div class="form-group">
                    <button class="btn btn-info btn-block">Créer ce compte</button>
                </div>
    </form>
    </div>
