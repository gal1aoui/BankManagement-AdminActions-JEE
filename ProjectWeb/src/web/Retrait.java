...
@WebServlet(name="Retrait", urlPatterns={"/retrait"})
public class Retrait extends HttpServlet {
	...
	req.getRequestDispatcher("Retrait.jsp").forward(req, res);
}
...
protected void doPost(HttpServletRequest req, HttpServletResponse res)
	...
	gpr.retirer(cmp_id, montant, emp_id);
	
	res.sendRedirect("retrait");
}
}
